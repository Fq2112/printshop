...
return [
    ...
    "mail" => [
        "subject" => [
            ...
            "expired" => "Order with Payment ID #:code has been Aborted",
        ...
        "content" => [
            ...
            "expired" => "Your order has been aborted by ".env('APP_NAME'),
            "expired2" => "Please, don't make any payments. Please contact ".env('APP_NAME')." if you have any questions regarding your order.",
