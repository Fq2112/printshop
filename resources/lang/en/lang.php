...
return [
    ...
    "modal" => [
        "auth" => [
            ...
            "pp-tnc" => "<small>By continuing this, you acknowledge that you accept on the <a href='" . route('info') . "' target='_blank'>Privacy Policy</a> and <a href='" . route('info') . "' target='_blank'>Terms & Conditions</a> of " . env('APP_TITLE') . ".</small>",
