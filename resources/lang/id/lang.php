...
return [
    ...
    "mail" => [
        "subject" => [
            ...
            "expired" => "Pesanan dengan ID Pembayaran #:code Telah Dibatalkan",
        ...
        "content" => [
            ...
            "expired" => "Pesanan Anda telah dibatalkan oleh ".env('APP_NAME'),
            "expired2" => "Mohon untuk tidak melakukan pembayaran apapun. Silakan hubungi ".env('APP_NAME')." jika memiliki pertanyaan terkait pesanan Anda.",
            ...
            "payment6" => "Pembayaran Dibatalkan",
