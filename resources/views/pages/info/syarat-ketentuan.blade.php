@extends('layouts.mst')
@section('title',  __('tnc.head').' | '.__('lang.title'))
@push('styles')
...
@section('content')
    <section id="page-title" class="page-title-parallax page-title-dark"
        ...
        <div class="container clearfix">
            <h1>{{__('lang.footer.tnc')}}</h1>
            <span>{{__('tnc.capt')}}</span>
            <ol class="breadcrumb text-uppercase">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{__('lang.footer.tnc')}}</li>
            </ol>
        </div>
    </section>
