...
@section('title', __('admin.sidebar.head').': Clients | '.env('APP_TITLE'))
@push('styles')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle" align="center">
                                                <img class="img-fluid" width="200" alt="logo"
                                                     src="{{asset('storage/clients/'.$row->logo)}}">
                                            </td>
                                            <td style="vertical-align: middle" align="center">
                                            ...
                                            <td style="vertical-align: middle" align="center">
                                                {{\Carbon\Carbon::parse($row->updated_at)->diffForHumans()}}</td>
                                            <td style="vertical-align: middle" align="center">
                                                <button data-placement="left" data-toggle="tooltip" title="Edit"
                                                        type="button" class="btn btn-warning mr-1"
                                                        onclick="editBlogPost('{{$row->id}}','{{$row->name}}','{{$row->logo}}')">
                                                    <i class="fa fa-edit"></i></button>
                                                <a href="{{route('delete.clients', ['id' => encrypt($row->id)])}}"
                            ...
                            <div id="content2" style="display: none;">
                                <form id="form-blogPost" method="post" action="{{route('add.clients')}}"
                                    ...
                                    <div class="row form-group">
                                        <div class="col has-feedback">
                                            ...
                                            <input id="name_client" type="text" maxlength="191" name="name"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" name="logo" class="custom-file-input"
                                                           ...
                                                           onchange="$('#txt_logo').text($(this).val().replace(/.*(\/|\\)/, ''))">
                                                    <label class="custom-file-label" id="txt_logo">Choose File</label>
                                                </div>
                                            </div>
                                            <div id="count_files" class="form-text text-muted">
                                                Allowed extension: jpg, jpeg, gif, png. Allowed size: < 5 MB. Allowed Resolution: 400x300 px
                                            </div>
                                        </div>
                                    </div>
...
@push("scripts")
    ...
    <script>
        ...
        $("#btn_create").on('click', function () {
            ...
            $("#form-blogPost").attr('action', '{{route('add.clients')}}');
            $("#form-blogPost input[name=_method], #form-blogPost input[name=id], #title").val('');
        ...
        function editBlogPost(id, name, logo) {
            $("#content1").toggle(300);
            $("#content2").toggle(300);
            ...
            $("#form-blogPost").attr('action', '{{route('update.clients')}}');
