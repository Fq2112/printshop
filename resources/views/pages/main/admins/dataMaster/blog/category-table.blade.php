...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{__('admin.tables.blog-category')}}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{route('admin.dashboard')}}">Dashboard</a></div>
                <div class="breadcrumb-item">Data Master</div>
                <div class="breadcrumb-item">Blog</div>
                <div class="breadcrumb-item">{{__('admin.sidebar.blog-category')}}</div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle" align="center">
                                                <button data-placement="left" data-toggle="tooltip" title="Edit"
                                                        ...
                                                        onclick="editBlogCategory('{{$row->id}}','{{$row->name}}')">
                                                    <i class="fa fa-edit"></i></button>
                                                <a href="{{route('delete.blog.categories', ['id' => encrypt($row->id)])}}"
...
@push("scripts")
    ...
    <script>
        ...
        function createBlogCategory() {
            ...
            $("#form-blogCategory").attr('action', '{{route('create.blog.categories')}}');
        ...
        function editBlogCategory(id, name) {
            $("#blogCategoryModal .modal-title").text('Edit Form');
            $("#form-blogCategory").attr('action', '{{route('update.blog.categories')}}');
