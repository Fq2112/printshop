                        ...
                        <div class="card-body">
                                    ...
                                    @foreach($data->getGallery as $row)
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle" align="center">
                                                ...
                                                <a href="{{route('table.categories.subs.gallery.delete',['id' => $row->id])}}" class="btn btn-danger delete-data"
                            ...
                            <div id="content2" style="display: none;">
                                <form id="form-blogGallery" method="post" enctype="multipart/form-data"
                                      action="{{route('table.categories.subs.gallery.add')}}">
                                    {{csrf_field()}}
                                    <input type="hidden" name="subkategori_id" value="{{$data->id}}">
