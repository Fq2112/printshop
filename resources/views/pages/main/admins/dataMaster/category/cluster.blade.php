...
@section('title', __('admin.sidebar.head').': Product Clusters | '.env('APP_TITLE'))
@push('styles')
                                ...
                                <form id="form-blogPost" method="post" action="{{route('create.categories')}}"
                                    ...
                                    <div class="row form-group" style="display: none">
                                        <div class="col">
                                            ...
                                            <div class="form-text text-muted">
                                                Allowed extension: jpg, jpeg, gif, png, rar, zip, pdf. Allowed size: < 5
                                                MB
                                            </div>
                                        </div>
                                    </div>
