    ...
    <div class="modal fade " id="blogCategoryModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document" style="width: 100%">
            <div class="modal-content">
                ...
                <form id="form-blogCategory" method="post" action="{{route('create.material')}}">
                    {{csrf_field()}}
                    <input type="hidden" name="_method">
                    <input type="hidden" name="id">
...
@push("scripts")
    ...
    <script>
        ...
        $("#btn_create").on('click', function () {
            ...
            $("#form-blogPost").attr('action', '{{route('create.material')}}');
        ...
        function createBlogCategory() {
            ...
            $("#form-blogCategory").attr('action', '{{route('create.material')}}');
        ...
        function editBlogCategory(id, name, name_id, caption) {
            ...
            $("#form-blogCategory").attr('action', '{{route('update.material')}}');
        ...
        function editBlogPost(id, url) {
            ...
            $("#form-blogPost").attr('action', '{{route('update.material')}}');
