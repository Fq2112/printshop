                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle" align="center">
                                                <button data-placement="left" data-toggle="tooltip" title="Edit"
                                                        ...
                                                        onclick="editBlogPost('{{$row->id}}','{{route('edit.front.posts', ['id' => $row->id])}}')">
                                                    <i class="fa fa-edit"></i></button>

                                                @if($row->isActive == 1)
                                                    <a href="{{route('delete.front', ['id' => encrypt($row->id)])}}"
    ...
    <div class="modal fade " id="blogCategoryModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document" style="width: 100%">
            <div class="modal-content">
                ...
                <form id="form-blogCategory" method="post" action="{{route('create.front')}}">
                    {{csrf_field()}}
                    <input type="hidden" name="_method">
                    <input type="hidden" name="id">
...
@push("scripts")
    ...
    <script>
        ...
        $("#btn_create").on('click', function () {
            ...
            $("#form-blogPost").attr('action', '{{route('create.front')}}');
        ...
        function createBlogCategory() {
            ...
            $("#form-blogCategory").attr('action', '{{route('create.front')}}');
        ...
        function editBlogCategory(id, name, name_id, caption) {
            ...
            $("#form-blogCategory").attr('action', '{{route('update.front')}}');
        ...
        function editBlogPost(id, url) {
            ...
            $("#form-blogPost").attr('action', '{{route('update.front')}}');
