...
use App\Models\PrintingMethods;
...
class PrintMethodController extends Controller
{
    ...
    {
        $data = PrintingMethods::all();

        return view('pages.main.admins.dataMaster.spec.print', [
            'title' => 'Print Methods Table',
            'kategori' => $data
        ]);
    }
    ...
    {
        return PrintingMethods::find($id);
    }

    public function update_data(Request $request)
    {

        $category = PrintingMethods::find($request->id);
    ...
    {
        $data = PrintingMethods::find(decrypt($id));
